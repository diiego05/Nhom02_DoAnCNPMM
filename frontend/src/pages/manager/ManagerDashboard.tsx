...
const ManagerDashboard = () => {
  ...
  const { data: pendingProducts, isLoading: isPendingProductsLoading } =
    usePendingProducts();
  ...
  const handleCreateVoucher = (e: React.FormEvent) => {
    ...
    if (!/^[A-Z0-9_-]+$/i.test(newVoucher.code)) {
      alert(
        "Mã voucher chỉ được bao gồm chữ cái, số, gạch ngang và gạch dưới!",
      );
      return;
    }
  ...
  const handleConfirmLockVendor = () => {
    ...
    updateVendorMutation.mutate(
      ...
      },
      {
        onSuccess: () => {
          addNotification(
            `Đã KHÓA Shop "${lockModal.vendorName}" - Lý do: ${lockModal.reason}`,
          );
          setLockModal({
            show: false,
            vendorId: null,
    ...
    <div className="min-h-screen bg-[#F4F4F0] flex overflow-hidden">
        ...
        <div className="p-4 border-t border-black/5">
          <div className="bg-amber-50 border-2 border-amber-300 rounded-xl p-3 flex gap-2">
            ...
            <div className="text-[10px] font-bold text-amber-800">
              Chế độ quản lý hệ thống. Mọi thao tác phê duyệt hoặc khóa tài
              khoản sẽ có hiệu lực trực tiếp trong cơ sở dữ liệu.
            </div>
          </div>
        </div>
      </aside>
              ...
              <div className="flex justify-between items-end">
                <div>
                  ...
                  <p className="text-gray-500 font-medium italic">
                    Giám sát hoạt động của các Vendor và Sản phẩm từ Database
                    thực tế.
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center border-b border-gray-200 pb-4">
                <div>
                  ...
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">
                    Duyệt sản phẩm mới hoặc quản lý / gỡ bỏ các sản phẩm vi phạm
                    chính sách
                  </p>
                </div>
              </div>
                                  ...
                                  <div className="flex-grow grid grid-cols-5 gap-8 items-center">
                                    <div className="col-span-2">
                                      ...
                                      <p className="text-[10px] font-bold text-gray-400 mt-1 uppercase">
                                        SKU: {product.slug || product.id} | Danh
                                        mục ID: {product.category_id}
                                      </p>
                                    </div>
                    ...
                    <>
                      {activeProducts?.filter(
                        ...
                        <div className="bg-white border-2 border-black rounded-[2.5rem] p-16 flex flex-col items-center text-center">
                          ...
                          <p className="text-xs text-gray-500 font-bold mt-1 uppercase">
                            Hiện tại không có sản phẩm nào đang hoạt động trên
                            sàn.
                          </p>
                        </div>
                      ) : (
                    ...
                    <>
                      {activeProducts?.filter(
                        ...
                        <div className="bg-white border-2 border-black rounded-[2.5rem] p-16 flex flex-col items-center text-center">
                          ...
                          <p className="text-xs text-gray-500 font-bold mt-1 uppercase">
                            Hệ thống hiện tại không có sản phẩm bị khóa hoặc bị
                            từ chối.
                          </p>
                        </div>
                      ) : (
                              ...
                              <div className="flex justify-between items-start border-b border-gray-100 pb-4">
                                <div>
                                  <div className="flex items-center gap-3 mb-2">
                                    <span className="text-xs font-black uppercase bg-black text-white px-3 py-1 rounded-md">
                                      Đơn hàng #
                                      {dispute.order_id ||
                                        dispute.shop_order_id}
                                    </span>
                                    <span
                                      className={`text-xs font-black uppercase px-3 py-1 rounded-md border-2 ${dispute.status === "RESOLVED_BY_ADMIN" || dispute.status === "COMPLETED" ? "bg-green-100 text-green-600 border-green-200" : "bg-red-100 text-red-600 border-red-200"}`}
                                    >
                                ...
                                <div className="flex gap-2">
                                  {dispute.status === "REJECTED" ? (
                                    ...
                                    <span
                                      className={`text-[9px] font-black uppercase px-3 py-1.5 rounded-full border ${dispute.status === "RESOLVED_BY_ADMIN" || dispute.status === "COMPLETED" ? "bg-green-50 text-green-600 border-green-100" : "bg-red-50 text-red-500 border-red-100"}`}
                                    >
                              ...
                              <div className="pt-2">
                                ...
                                <div className="space-y-3">
                                  {dispute.items?.map((item: any) => (
                                    ...
                                    >
                                      {item.orderItem?.variant?.product
                                        ?.images?.[0]?.image_url ? (
                                        <img
                                          src={
                                            item.orderItem.variant.product
          ...
          {activeTab === "marketing" && (
            <div className="space-y-10">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                              ...
                              >
                                <div className="flex-grow">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span
                                      className={`text-[8px] font-black uppercase px-2 py-0.5 rounded border ${statusClass}`}
                                    >
                                      {statusLabel}
                                    </span>
                                  </div>
                                ...
                                <button
                                  onClick={() =>
                                    handleDeleteVoucher(v.id, v.code)
                                  }
                ...
                <div className="bg-white border-2 border-black rounded-[2rem] p-8 shadow-sm flex flex-col gap-6">
                  <h3 className="text-lg font-black uppercase tracking-tighter flex items-center gap-2 border-b border-gray-100 pb-4">
                    <Megaphone className="text-primary" /> Thiết lập chiến dịch
                    Flash Sale
                  </h3>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        >
                          ...
                          <option value="Banner Marketing">
                            Banner Marketing
                          </option>
                          <option value="Sự kiện toàn sàn">
                            Sự kiện toàn sàn
                          </option>
                        </select>
                      </div>
          ...
          {activeTab === "vendors" && (
            <div className="space-y-8">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-3xl font-serif font-black uppercase">
                    Quản lý & Hỗ trợ (Khóa Shop)
                  </h2>
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">
                    Giám sát trạng thái của các gian hàng bán trên sàn
                  </p>
                </div>
              </div>
                          ...
                          .map((vendor: any) => (
                            ...
                            >
                              ...
                              <td className="px-8 py-6 text-xs font-bold text-gray-600">
                                <p>
                                  {vendor.vendor?.profile?.full_name || "N/A"}
                                </p>
                              ...
                              <td className="px-8 py-6">
                                <span
                                  className={`text-[9px] font-black uppercase px-3 py-1.5 rounded-full border ${vendor.status === "BANNED" ? "bg-red-50 text-red-500 border-red-100" : "bg-green-50 text-green-600 border-green-100"}`}
                                >
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-6 animate-in fade-in duration-200">
          <div className="bg-white border-4 border-black rounded-[2rem] p-8 max-w-md w-full shadow-brutal flex flex-col gap-6 transform animate-in slide-in-from-bottom-8 duration-300">
            ...
            <div className="text-sm font-bold text-gray-600 leading-relaxed">
              ...
              . Hành động này sẽ tạm ngừng quyền bán lẻ và ẩn mọi sản phẩm thuộc
              gian hàng này.
            </div>
      ...
      {rejectModal.isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/20 backdrop-blur-sm">
          <div className="bg-white border-2 border-black rounded-[2rem] p-8 w-full max-w-md shadow-brutal relative animate-in fade-in zoom-in duration-200">
            <button
              onClick={() =>
                setRejectModal({
                  isOpen: false,
              ...
              className="absolute top-6 right-6 p-2 bg-gray-100 hover:bg-black hover:text-white rounded-full transition-colors"
            >
              <X size={16} />
            </button>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-red-100 text-red-600 rounded-full flex items-center justify-center border-2 border-red-200">
                <AlertCircle size={24} />
              </div>
              <div>
                ...
                <p className="text-xs font-bold text-gray-400">
                  Đơn hàng #{rejectModal.orderCode}
                </p>
              </div>
            </div>
            <div className="space-y-4">
